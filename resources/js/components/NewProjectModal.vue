...
<form @submit.prevent="submit">
    <modal name="new-project-modal" classes="p-10 bg-card rounded-lg" height="auto">
                ...
                <div class="flex-1 mr-4">
                    <div class="mb-4">
                        ...
                        <input type="text" id="title" 
                            ...
                            v-model="form.title"
                        >
                        <span class="text-sm italic text-red" v-if="form.errors.title" v-text="form.errors.title[0]"></span> 
                    </div>

                    <div class="mb-4">
                        <label for="description" class="text=sm block mb-2">Description</label>
                        <textarea id="description" class="border border-muted-light p-2 text-xs block w-full rounded" rows="7" v-model="form.description">
                        </textarea>
                        <span class="text-sm italic text-red" v-if="form.errors.description" v-text="form.errors.description[0]"></span> 
                    </div>
                </div>
            ...
            <footer class="flex justify-end">
                <button type="button" class="button mr-4" @click="$modal.hide('new-project-modal')">Cancel</button>
